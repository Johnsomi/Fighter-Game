			...
			if (tutorialScreen.Bool == true)
			{
				...
				else if (tutorialfive == true)
				{
					...
					catch (ArgumentOutOfRangeException ex)
					{
						...
						var errorfile = File.Create("errorTemptFateScreenManager");
						errorfile.Close();
						File.WriteAllText("errorTemptFateScreenManager", ex.Message);
					}
				}
				else if (tutorialsix == true)
				{
					...
					{
						var errorfile = File.Create("errorTemptFate");
						errorfile.Close();
						File.WriteAllText("errorTemptFate", ex.Message);
					}
				}
