	...
	public class Mystic : Character
	{
		...
		public override void Update(GameTime gameTime, List<Line> Lines, GamePadState gamepadstate, Character enemy)
		{
			...
			catch (ArgumentOutOfRangeException ex)
			{
				...
				var errorfile = File.Create("errorTemptFateMystic");
				errorfile.Close();
				File.WriteAllText("errorTemptFateMystic", ex.Message);
			}
			//Update Bullets
			...
			using (var stream = File.Create("Debugging_VariablesMystic")) { }
			using (StreamWriter nf = new StreamWriter("Debugging_VariablesMystic"))
			{
